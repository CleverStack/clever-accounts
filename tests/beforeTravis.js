...
function copyAccountsModule() {
  return new Promise(function(resolve, reject) {
    var fromDir     = path.join(__dirname, '../')
      , toDir       = path.join(__dirname, '../', prName, 'modules', 'clever-accounts');

    console.log('step #' + step + ' - copy clever-accounts module in test project - begin\n');
